<HTML>
<HEAD><TITLE>Estadisticas de a 200</TITLE>
<style type="text/css">
.style1 {
	text-align: center;
}
...
%>
  <FONT SIZE="+2" color="red">Pisos y Pavimentos<br>
  </FONT>
...
Else
%>
  <a href="./contador.asp?eje=30&page=<%= I %>"><%= I %></a>
  <%
End If
Next 'I
...
%>
  ...
  <br>
  <FONT color="#3366FF">
	<p> <a href="_contador-1000.asp">Ver de a 1000</a></p>
	<p> <a href="_contador-10000.asp">Ver de a 10000</a></p>
  </FONT>
</div>
</BODY>
</HTML>